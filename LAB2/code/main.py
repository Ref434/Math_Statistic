...
def build_params(distribution):
    for size in sizes:
        mean_list, med_list, z_r_list, z_q_list, z_tr_list, e_list, d_list, res1_list, res2_list = [], [], [], [], [], [], [], [], []
        ...
        for i in range(len(e_list)):
            res1_list.append(e_list[i] + math.sqrt(d_list[i]))
            res2_list.append(e_list[i] - math.sqrt(d_list[i]))
